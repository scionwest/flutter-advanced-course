...
ThemeData getApplicationTheme() {
  return ThemeData(
    ...
    textTheme: TextTheme(
      ...
      subtitle1: getMediumStyle(color: ColorManager.lightGrey, fontSize: FontSize.normal),
      subtitle2: getMediumStyle(color: ColorManager.primary, fontSize: FontSize.normal),
